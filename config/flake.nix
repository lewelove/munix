  ...
  in {
    ...
    lib = {
      ...
      evalConfig = albumArgs: let
        envOrigin = builtins.getEnv "MUTE_ORIGIN_PATH";
        envSourceName = builtins.getEnv "MUTE_SOURCE_NAME";
      ...
      mkAlbum = args@{ 
        ...
        envOrigin = builtins.getEnv "MUTE_ORIGIN_PATH";
        envSanitizedSourceName = builtins.getEnv "MUTE_SANITIZED_SOURCE_NAME";
